  ...
  return (
    <GridContainer>
      <GridItem xs={12} sm={12} md={12}>
        <CustomTabs
          title={`${Dictionary.defValue(DictionaryService.keys.eventsDashboard)}:`}
          headerColor="primary"
          tabs={[
            {
                  ...
                  <GridContainer>
                    <GridItem xs={12} sm={12} md={12}>
                      <Card chart>
                        ...
                        <CardBody>
                          <h4
                            className={classes.cardTitle}>{Dictionary.defValue(DictionaryService.keys.activity)}</h4>
                          <p className={classes.cardCategory}>
                  <span className={classes.successText}>
                    <ArrowUpward className={classes.upArrowCardCategory}/> 55%
                  </span>{" "}
                            {Dictionary.defValue(DictionaryService.keys.inTodayActivity, Dictionary.defValue(DictionaryService.keys.increase))}.
                          </p>
                        </CardBody>
                        <CardFooter chart>
                          <div className={classes.stats}>
                            <AccessTime/> {Dictionary.defValue(DictionaryService.keys.updatedMinutesAgo, "4")}
                          </div>
                        </CardFooter>
                      </Card>
                    </GridItem>
            ...
            },
            {
              ...
              tabContent: <UsersTable
                handleClick={(userId: string) => props.history.push(EVENTS_USERS_LIST_ROUTE + "/" + userId)}
              />
            }
          ]}
        />
