...
const EmailTemplatesDialog = (props: {open: boolean, handleClose: () => void, onSelect: (template: number) => void}) => {
...
const CloseEditorDialog = (props: {open: boolean, onOk: () => void, onCancel: () => void}) => {
...
const Editor = (props: IBeeComponent) => {
 const classes = useStyles();
...
export default React.memo((props: IBeeComponent & {open: boolean}) => {
