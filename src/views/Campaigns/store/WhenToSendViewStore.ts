...
import {IOneTimeRunView, IRecurringRunView, IRunTypeView, ITriggerRunView} from "interfaces/IRunTypeView";
...
export class WhenToSendViewStore implements IWhenToSendStep {
 ...
 @action setCurrentRunType(currentRunType: RunType) {
  ...
  this.runStore = [this.oneTimeRunViewStore, this.triggerRunViewStore, this.recurringRunViewStore][this.currentRunType - 1];
 }
}
